#Starter Kit for Building Applications in React and Redux with ES6

## Getting Started
1. **Install [Node LTS](https://nodejs.org)**.
2. **Clone this repository.** - `git clone https://github.com/isijara/react-redux-starter-kit.git`
